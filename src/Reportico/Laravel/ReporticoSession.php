...
// Override standard Reportico Engine session handler with aravel Specific one
namespace Reportico\Laravel;
...
class ReporticoSession
{
    ...
    static function setUpReporticoSession()
    {
        ...
        if (isset($_REQUEST['reportico_session_name'])) {
            ...
            if (preg_match("/_/", $session_name)) {
                ...
                \Reportico\Engine\ReporticoApp::set("session_namespace", $ar[1]);
                if (\Reportico\Engine\ReporticoApp::get("session_namespace")) {
                    \Reportico\Engine\ReporticoApp::set("session_namespace_key", "reportico_" . \Reportico\Engine\ReporticoApp::get("session_namespace"));
                }
        ...
        if (strlen($session_name) >= 3 && substr($session_name, 0, 3) == "NS_") {
            ...
            \Reportico\Engine\ReporticoApp::set("session_namespace", substr($session_name, 3));

            // IF NS_NEW passed then autogenerate session namespace from current time
            if (\Reportico\Engine\ReporticoApp::get("session_namespace") == "NEW") {
                \Reportico\Engine\ReporticoApp::set("session_namespace", date("YmdHis"));
            }
            if (\Reportico\Engine\ReporticoApp::get("session_namespace")) {
                \Reportico\Engine\ReporticoApp::set("session_namespace_key", "reportico_" . \Reportico\Engine\ReporticoApp::get("session_namespace"));
            }
    ...
    {
        if ( \Session::has(\Reportico\Engine\ReporticoApp::get("session_namespace_key")))
            return true;
        else
            return false;
    }
    ...
    {
        if (!$session_name)
            $session_name = \Reportico\Engine\ReporticoApp::get("session_namespace_key");
    ...
    {
        if (!$namespace)
            $namespace = \Reportico\Engine\ReporticoApp::get("session_namespace_key");
    ...
    {
        $session_namespace_key = \Reportico\Engine\ReporticoApp::get("session_namespace_key");
    ...
    {
        //if ( \Reportico\Engine\ReporticoApp::get("session_namespace") )
        return "NS_" . \Reportico\Engine\ReporticoApp::get("session_namespace");
    }
    ...
    {
        return \Reportico\Engine\ReporticoApp::get("session_namespace_key");
    }
