<?php namespace Reportico\Laravel;
    ...
    */
	...
	function handle_xml_query_input($mode=false)
	{
        ...
        if ( $do_defaults)
        {
		    ...
		    global $g_project;
            $old_error_handler = set_error_handler("\Reportico\Laravel\ErrorHandler", 0);
            ...
            $old_error_handler = set_error_handler("\Reportico\Laravel\ErrorHandler");
        }
	...
	function execute($mode=false, $draw=true)
	{
		...
		$old_error_handler = set_error_handler("\Reportico\Laravel\ErrorHandler");
        set_exception_handler("\Reportico\Laravel\ExceptionHandler");
...
$code = "namespace Reportico\Laravel;". $code;
